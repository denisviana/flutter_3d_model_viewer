...
import '../android/bundle.dart' show Bundle;
import '../android/component_name.dart';
import '../android/parcel.dart' show Parcel;
import '../android/parcelable.dart' show Parcelable;
...
class Intent with Parcelable {
  ...
  String? get category => categories?.isNotEmpty == true ? categories?.first : null;
